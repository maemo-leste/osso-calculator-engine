...
# include <calc/shs.h>
/*# include <calc/shs1.h>
# include <calc/md5.h> -TL*/
# include <calc/zmath.h>
#endif


/* MAX_CHUNKSIZE is the largest chunksize of any hash */
/*#define MAX_CHUNKSIZE (SHS1_CHUNKSIZE) -TL*/
#define MAX_CHUNKSIZE (SHS_CHUNKSIZE)
...
struct hashstate {
	...
	union {				/* hash dependent states */
		...
		MD5_CTX h_md5;		// MD5 internal state -TL*/
	} h_union;
};
...
#define MD5_BASE 0x34feed00		// MD5 -TL*/
