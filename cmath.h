...
extern COMPLEX *mycsqrt(COMPLEX *c, NUMBER *epsilon, long R);
extern COMPLEX *croot(COMPLEX *c, NUMBER *q, NUMBER *epsilon);
extern COMPLEX *mycexp(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *cln(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *myccos(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *mycsin(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *myccosh(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *mycsinh(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *cpolar(NUMBER *q1, NUMBER *q2, NUMBER *epsilon);
extern COMPLEX *crel(COMPLEX *c1, COMPLEX *c2);
extern COMPLEX *mycasin(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *mycacos(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *mycatan(COMPLEX *c, NUMBER *epsilon);
...
extern COMPLEX *mycasinh(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *mycacosh(COMPLEX *c, NUMBER *epsilon);
extern COMPLEX *mycatanh(COMPLEX *c, NUMBER *epsilon);
