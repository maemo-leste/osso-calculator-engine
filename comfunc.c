 ...
 */
COMPLEX *
mycsqrt(COMPLEX *c, NUMBER *epsilon, long R)
{
	COMPLEX *r;
 ...
 */
COMPLEX *
mycexp(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *r;
	...
	if (qiszero(epsilon)) {
		math_error("Zero epsilon for mycexp");
		/*NOTREACHED*/
	}
	if (cisreal(c)) {
 ...
 */
COMPLEX *
myccos(COMPLEX *c, NUMBER *epsilon)
{
	...
	if (qiszero(epsilon)) {
		math_error("Zero epsilon for myccos");
		/*NOTREACHED*/
	}
	n = qilog2(epsilon);
	ctmp1 = comalloc();
 ...
 */
COMPLEX *
mycsin(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *r, *ctmp1, *ctmp2, *ctmp3;
	...
	if (qiszero(epsilon)) {
		math_error("Zero epsilon for mycsin");
		/*NOTREACHED*/
	}
	if (ciszero(c))
		return clink(&_czero_);
...
COMPLEX *
myccosh(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2, *tmp3;

	tmp1 = mycexp(c, epsilon);
	if (tmp1 == NULL)
		return NULL;
	tmp2 = cneg(c);
...
COMPLEX *
mycsinh(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2, *tmp3;
...
COMPLEX *
mycasin(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2;

	tmp1 = cmul(&_conei_, c);
	tmp2 = mycasinh(tmp1, epsilon);
	comfree(tmp1);
...
COMPLEX *
mycacos(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2;
...
COMPLEX *
mycasinh(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2, *tmp3;
	BOOL neg;
...
COMPLEX *
mycacosh(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2;
...
COMPLEX *
mycatan(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2, *tmp3;
...
COMPLEX *
mycatanh(COMPLEX *c, NUMBER *epsilon)
{
	COMPLEX *tmp1, *tmp2, *tmp3;
